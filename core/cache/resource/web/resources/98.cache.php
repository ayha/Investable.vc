<?php  return array (
  ...
  array (
    ...
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 1423992420,
    'parent' => 36,
    'isfolder' => 0,
    'introtext' => 'Empowering smartphone videographers',
    'content' => '<p>Grip Gear products make it easy to shoot great quality and fun videos with your smartphones. <a name="anchor2"></a>We make items that are light, fun and functional, connect your smart phone to our gadgets to unleash the power of your smart phone camera.</p>
<p>website: <a href="http://www.gripgear.com" target="_blank">www.gripgear.com</a></p>',
    'richtext' => 1,
    'template' => 35,
    'menuindex' => 9,
    'searchable' => 1,
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1415352516,
    'editedby' => 1,
    'editedon' => 1415352869,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1415352480,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'en/startup-companies/grip-gear.html',
    'uri_override' => 0,
    ...
    array (
      0 => 'youtube',
      1 => 'http://www.youtube.com/embed/rdn69bA2Nvs',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'content_image',
      1 => 'assets/images/startups/grip_gear/Airpod-01-706x649.png',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
...
<title>Investable.vc - Grip Gear</title>
...
<li  class="last">
   ...
   <a href="en/member/investor-portfolio.html" id="porfolio"  class="tool_button" title="My Portfolio">
   		<img src="/assets/images/heart_icon_36.png" title="My Portfolio" />
			...
			<div class="member_content">
				<div class="quick_facts">
					<div class="project_logo col-md-4">
						<div class="logo_holder" style="background-image:url(/assets/components/phpthumbof/cache/Airpod-01-706x649.5e6a4892fa86ca2b9b97dd5d6041a51a98.png);"></div>
					...
					<div class="project_status col-md-8"> 
						<h2>Grip Gear</h2>
						<h3><span class="industry">Hardware</span>, <span class="country">Hong Kong</span></h3>
						<div class="intro">Empowering smartphone videographers</div>
						<div class="fund_status">
							...
							<div class="status_item  col-xs-6  col-sm-4" id="premoney" data-value="400000">
								<div class="status_name">Pre-money Valuation

</div>
								<div class="status_number">$400,000</div>
								<div class="allclear"></div>
							</div>
							
							
							
							<div class="status_item  col-xs-6  col-sm-4" id="postmoney" data-value="500000">
								<div class="status_name">Post-money Valuation</div>
								<div class="status_number">$500,000</div>
								<div class="allclear"></div>
							</div>
							
							
							
							<div class="status_item col-xs-6  col-sm-4" id="countdown" data-target_date="2015-02-15 17:27:00">
				...
				<div class="company_info">
					<div class="company_details col-md-8">
							...
							<iframe width="100%" height="300" src="//www.youtube.com/embed/rdn69bA2Nvs" frameborder="0" allowfullscreen></iframe>
						...
						<div class="company_description">
							...
							<h3>Company Description</h3><p>Grip Gear products make it easy to shoot great quality and fun videos with your smartphones. <a name="anchor2"></a>We make items that are light, fun and functional, connect your smart phone to our gadgets to unleash the power of your smart phone camera.</p>
<p>website: <a href="http://www.gripgear.com" target="_blank">www.gripgear.com</a></p>
					...
					<div class="company_founder col-md-4">
						...
						[[!get_company_founders? &founders=`369`]]
				...
				<div class="floating_content">
					<div class="support_company">
						<a class="btn support_button invest_company" title="Support" href="#">Invest (<span class="count">[[!get_company_investors? &companyid=`98` &getCount=`1`]]</span>)</a>
						<a class="btn support_button follow_company" title="Follow" href="#">Follow (<span class="count">[[!get_company_followers? &companyid=`98` &getCount=`1`]]</span>)</a>
...
<script type="text/javascript">
  ...
  'elementCache' => 
  array (
    '[[$member_head]]' => '[[!isLoggedIn?]][[!Profile]]',
    '[[*pagetitle]]' => 'Grip Gear',
    '[[*description]]' => '',
    '[[If? 
    &subject=`0`
...
<li  class="last">
  ...
  <a href="en/member/member-profile.html" id="update_profile"  class="tool_button" title="Update Profile">
    ...
    '[[*content_image:phpthumbof=`w=500&h=300`]]' => '/assets/components/phpthumbof/cache/Airpod-01-706x649.5e6a4892fa86ca2b9b97dd5d6041a51a98.png',
    ...
    '[[*introtext:nl2br]]' => 'Empowering smartphone videographers',
    '[[*stage]]' => 'Seed',
    ...
    '[[*equity:ne=``:then=`
							<div class="status_item  col-xs-6  col-sm-4" id="equity" data-value="">
...
',
    '[[*premoney:numberformat=`&decimals=0&dec_point=.&thousands_sep=,`]]' => '400,000',
    '[[*premoney:ne=``:then=`
							<div class="status_item  col-xs-6  col-sm-4" id="premoney" data-value="400000">
								<div class="status_name">Pre-money Valuation
    ...
    '[[*postmoney:numberformat=`&decimals=0&dec_point=.&thousands_sep=,`]]' => '500,000',
    '[[*postmoney:ne=``:then=`
							<div class="status_item  col-xs-6  col-sm-4" id="postmoney" data-value="500000">
								<div class="status_name">Post-money Valuation</div>
								<div class="status_number">$500,000</div>
							...
							',
    '[[*unpub_date]]' => '2015-02-15 17:27:00',
    ...
    '[[*invested_by_angellist:ne=``:then=`
							...
							`]]' => '',
    '[[*youtube]]' => 'http://www.youtube.com/embed/rdn69bA2Nvs',
    '[[getYouTubeId? &input=`http://www.youtube.com/embed/rdn69bA2Nvs`]]' => 'rdn69bA2Nvs',
    '[[*youtube:ne=``:then=`
							<iframe width="100%" height="300" src="//www.youtube.com/embed/rdn69bA2Nvs" frameborder="0" allowfullscreen></iframe>
    ...
    '[[*content:ne=``:then=`<h3>Company Description</h3><p>Grip Gear products make it easy to shoot great quality and fun videos with your smartphones. <a name="anchor2"></a>We make items that are light, fun and functional, connect your smart phone to our gadgets to unleash the power of your smart phone camera.</p>
<p>website: <a href="http://www.gripgear.com" target="_blank">www.gripgear.com</a></p>`]]' => '<h3>Company Description</h3><p>Grip Gear products make it easy to shoot great quality and fun videos with your smartphones. <a name="anchor2"></a>We make items that are light, fun and functional, connect your smart phone to our gadgets to unleash the power of your smart phone camera.</p>
<p>website: <a href="http://www.gripgear.com" target="_blank">www.gripgear.com</a></p>',
    '[[%startups.business_model? &topic=`default` &namespace=`investable` &language=`en`]]' => 'Business Model & Monetization',
    '[[*business_model]]' => '',
    '[[*business_model:ne=``:then=`<h3>Business Model & Monetization</h3>`]]' => '',
...
<div class="navbar-top">
  ...
  <div class="container">
   ...
   <a href="[[~51]]" id="porfolio"  class="tool_button" title="[[%member.portfolio? &topic=`default` &namespace=`investable` &language=`en`]]">
   		<img src="/assets/images/heart_icon_36.png" title="[[%member.portfolio? &topic=`default` &namespace=`investable` &language=`en`]]" />
...
<script type="text/javascript">
   ...
   <div class="profile_head">
     <div class="col-xs-6 profile_name">
        <div class="founder_title">[[+title]]</div>
        <h3>[[+fullname]]</h3>
     </div>
...
return $output;',
      ...
      array (
        ...
        array (
          ...
          'category' => 9,
          'cache_type' => 0,
          'snippet' => '//[[!getUserById? &uid=`[[*founder]]` &tpl=`founder_profile`]] 
...
if(!empty($founders)){
   ...
   return $output;
          ...
          'static' => false,
          'static_file' => '',
          'content' => '//[[!getUserById? &uid=`[[*founder]]` &tpl=`founder_profile`]] 
...
if(!empty($founders)){
   ...
   return false;
          ...
          'moduleguid' => '',
          'static' => true,
          'static_file' => 'assets/snippets/get_user_by_id.php',
